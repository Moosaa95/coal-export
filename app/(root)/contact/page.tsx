    ...
    <div className="bg-black-100 text-gray-300">
      ...
      <section className="relative w-full h-[50vh] flex items-center justify-center text-center text-white">
        <motion.div
            ...
            >
            <h1 className="text-4xl md:text-5xl font-bold text-white">Connect with Trust Box</h1>
            <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
                At Trust Box, we are committed to fostering strategic partnerships and delivering value-driven solutions. 
                Reach out to us today to explore opportunities, discuss collaborations, or inquire about our services.
            </p>
        </motion.div>
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          >
            ...
            <p>Plot 2787, Shehu Shagari way, Maitama Abuja Nigeria</p>
          </motion.div>
          <motion.div
            className="bg-black-300 p-6 shadow-lg rounded-lg"
            initial={{ opacity: 0, y: 20 }}
